...
import cotan.Linear as Linear
import torch

from peft.tuners.tuners_utils import BaseTunerLayer


class CoTAnLayer(nn.Module, BaseTunerLayer):
    def __init__(
            self,
            pre_layer: nn.Module,
            in_features: int,
        ...
        self.adapter = Linear.CoTAnLinear(r, init_strategy=init_strategy, base_tensor=base_tensor, X=X)
        with torch.no_grad():
